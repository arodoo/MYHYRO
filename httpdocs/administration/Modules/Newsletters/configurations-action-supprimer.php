...
if (
  ...
  // Delete the newsletter subscriber
  $sql_delete = $bdd->prepare("DELETE FROM Newsletter_listing WHERE id=?");
  $sql_delete->execute(array($idaction));
  $sql_delete->closeCursor();

  $result = array("Texte_rapport" => "Abonné supprimé avec succès !", "retour_validation" => "ok", "retour_lien" => "");
