...
tinyMCE.triggerSave();
$.post({
url : '/administration/Modules/Membres-moderateurs/Moderateurs/Moderateurs-action-ajouter-modifier-ajax.php',
type : 'POST',
...
//AJAX - SUPPRIMER
$(document).on("click", ".supprimer-moderateur", function (){
$.post({
url : '/administration/Modules/Membres-moderateurs/Moderateurs/Moderateurs-action-supprimer-ajax.php',
type : 'POST',
...
$.post({
url : '/administration/Modules/Membres-moderateurs/Moderateurs/Moderateurs-liste-ajax.php',
type : 'POST',
dataType: "html",
success: function (res) {
...
<ol class="breadcrumb">
  ...
  <?php if(empty($_GET['action'])){ ?> <li class="active">Gestion des modérateurs</li> <?php }else{ ?> <li><a href="?page=Moderateurs">Gestion des modérateurs</a></li> <?php } ?>
...
<div id='bloctitre' style='text-align: left;' ><h1>Gestion des modérateurs</h1></div><br /><br />
...
echo "<a href='?page=Moderateurs'><button type='button' class='btn btn-info' style='margin-right: 5px;' ><span class='uk-icon-users'></span> Gestion des modérateurs </button></a>";
echo "<a href='?page=Moderateurs-modules'><button type='button' class='btn btn-primary' style='margin-right: 5px;' ><span class='uk-icon-check-square'></span> Modules autotisés </button></a>";
...
if(!empty($action)){
echo "<a href='?page=Moderateurs-groupes'><button type='button' class='btn btn-success' style='margin-right: 5px;' ><span class='uk-icon-file-text'></span> Liste des modérateurs</button></a>";
}
