...
?>
<?php
echo "<div class='col-md-12' style='text-align: left; margin-bottom: 35px;'>
	$Contenu_cfg_blog
</div>";
?>
...
///////////////////////////////SELECT
$nbr_consultation_blog=  $nbr_consultation_blog++;
...
if($action == "Categorie"){
///////////////////////////////SELECT BOUCLE
$req_boucle = $bdd->prepare("SELECT * FROM codi_one_blog WHERE id_categorie=? AND activer=? ORDER BY date_blog DESC");
$req_boucle->execute(array($idaction,'oui'));
}else{
///////////////////////////////SELECT BOUCLE
$req_boucle = $bdd->prepare("SELECT * FROM codi_one_blog WHERE activer='oui' ORDER BY date_blog DESC");
$req_boucle->execute();
}
/////////////////////////////////////////////////////////////////PAGINATION BLOG OU CATEGORIES - SQL
...
?>
	<div class='col-md-12' style='text-align: left;'>
		<h2 style='margin-top:0px;'>
			<a href='<?php echo "$http"; ?><?php echo "$nomsiteweb"; ?>/<?php echo "$url_fiche_blog_artciles_blog"; ?>'>
				<?php echo "$titre_blog_1_artciles_blog"; ?>
			</a>
		</h2>
		<div style='text-align: left;'>
