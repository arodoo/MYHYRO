...
$annuler_colis = $_POST['annuler_colis'];
...
if (isset($user)) {
    if(isset($id)){
        ...
        if(!empty($annuler_colis) && $annuler_colis == "oui"){
            $sql_update = $bdd->prepare("UPDATE membres_colis SET
        statut_2=?,
        sous_total = ?,
        prix_total = ?,
        ...
        $sql_update = $bdd->prepare("INSERT INTO admin_colis_historique
        (
            id_colis, 
            id_membre,
            pseudo,
        ...
        WHERE id=?");
            ...
            $sql_update = $bdd->prepare("INSERT INTO membres_transactions_colis
        ( 
            id_membre,
            id_colis,
            date,
