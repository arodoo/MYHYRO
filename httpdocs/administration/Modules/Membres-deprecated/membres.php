...
?>
  ...
  <script>
    $(document).ready(function() {
      ...
      function listeCompteMembre() {
        $.post({
          url: '/administration/Modules/Membres-deprecated/membres-action-liste-ajax.php',
          type: 'POST',
          dataType: "html",
          success: function(res) {
  ...
  <ol class="breadcrumb">
    ...
    <?php if (empty($_GET['action'])) { ?> <li class="active">Gestion des membres</li> <?php } else { ?> <li><a href="?page=Membres">Gestion des membres</a></li> <?php } ?>
  ...
  <?php
  echo "<div id='bloctitre' style='text-align: left;'><h1>Gestion des membres</h1></div><br />
<div style='clear: both;'></div>";
  ...
  echo "<a href='?page=Membres-logs'><button type='button' class='btn btn-primary' style='margin-right: 5px;' ><span class='uk-icon-folder'></span> Logs des membres</button></a>";
  if ($_GET['action'] != "Ajouter") {
    echo "<a href='?page=Membres&amp;action=Ajouter'><button type='button' class='btn btn-success' style='margin-right: 5px;' ><span class='uk-icon-history'></span> Ajouter un membre</button></a>";
  }
  if (isset($_GET['action'])) {
    echo "<a href='?page=Membres'><button type='button' class='btn btn-success' style='margin-right: 5px;' ><span class='uk-icon-history'></span> Liste des membres</button></a>";
  }
