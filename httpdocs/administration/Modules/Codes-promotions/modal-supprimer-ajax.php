...
$req_select = $bdd->prepare("SELECT Titre_promo FROM codes_promotion WHERE id = ?");
$req_select->execute(array($idaction));
$codepromo = $req_select->fetch();
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>Êtes-vous sûr(e) de vouloir supprimer <?php echo $codepromo['Titre_promo']; ?> ?</p>
      </div>
