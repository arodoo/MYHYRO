...
<tfoot>
<tr>
	<th scope="col" class="search_table" style="text-align: center;">TITRE</th>
...
<?php
	///////////////////////////////SELECT BOUCLE
	$req_boucle = $bdd->prepare("SELECT * FROM categories ".$_SESSION['recherche_par_type_WHERE']." ORDER BY nom_categorie ASC");
	$req_boucle->execute();
...
echo "<tr><td style='text-align: center;'>$nom_categorie</td>";
echo "<td style='text-align: center;'>$activer</td> 
<td style='text-align: center;'><a href='?page=Categories&amp;action=Modifier&amp;idaction=".$idd."' title='Modifier' data-id='".$idd."' ><span class='uk-icon-file-text' ></span></a></td>
