...
?>
	<div class='texte_page' style='text-align: left;'>
		<!-- CONTENU PAGE LISTE DE SOUHAIT -->
		<?php if($namepage == "Liste-de-souhaits"){?>
			<?php //echo "$contenu_page"; ?>
				<p style="margin-bottom: 1rem">
					Décrivez ici, vos besoins, les produits que vous désirez acheter, joignez des images, indiquez des références, nous les rechercherons pour vous.
					Nous vous notifierons de l'ajout dans votre panier et vous n'aurez simplquement qu'à effectuer le règlement et nous les commanderons pour vous.
				</p>
		<?php }?>
	</div>
<?php 
