...
?>
    ...
    <ol class="breadcrumb">
        ...
        <?php if (empty($_GET['action'])) { ?> <li class="active">Colis</li> <?php } else { ?> <li><a href="?page=Envoyer-colis">Colis</a></li> <?php } ?>
        <?php if ($_GET['action'] == "modifier") { ?> <li class="active">Consultation</li> <?php } ?>
        <?php if ($_GET['action'] == "addm") { ?> <li class="active">Ajouter</li> <?php } ?>
    </ol>

    <?php
    echo "<div id='bloctitre' style='text-align: left;'><h1>Colis</h1></div><br />
<div style='clear: both;'></div>";
    ...
    if (isset($_GET['action'])) {
        echo "<a href='?page=Envoyer-colis'><button type='button' class='btn btn-success' style='margin-right: 5px;' ><span class='uk-icon-history'></span> Liste des colis</button></a>";
    }
    ...
    <div style='text-align: center;'>
        ...
        if($action == "Details"){
            ...
            <div id="details-colis" style="clear:both;"></div>
        <?php }
        ...
        ?>
            ...
            <div id='liste-colis' style='clear: both;'></div>
