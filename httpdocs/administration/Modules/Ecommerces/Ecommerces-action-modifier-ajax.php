...
$sql_update = $bdd->prepare("INSERT INTO categories_liens
	(
		nom, 
		lien,
		id_categorie, 
...
$result = array("Texte_rapport"=>"Site recommandé créé avec succès !","retour_validation"=>"ok","retour_lien"=>"");
...
if($image_ok == "ok" ){
///////////////////////////////UPDATE
$sql_update = $bdd->prepare("UPDATE categories_liens SET 
	nom_categorie_image=?
	WHERE id=?");
...
$result = array("Texte_rapport"=>"Site recommandé modifié avec succès !","retour_validation"=>"ok","retour_lien"=>"");
