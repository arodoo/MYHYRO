...
///////////////////////////////SELECT BOUCLE
$req_boucle = $bdd->prepare("SELECT * FROM pages_redirections_301 order by ancienne_page DESC");
$req_boucle->execute();
...
<td style="text-align: center; width: 90px; <?php echo "$colorback"; ?>"><?php echo "<a href='?page=Pages-301&amp;action=modification&amp;idaction=".$idoneinfos."' style='".$colorback."' ><span class='uk-icon-file-text' ></span></a>"; ?></td>
<td style="text-align: center; border: width: 90px; <?php echo "$colorback"; ?>" ><?php echo "<a id='btnSupprModal' data-id='".$idoneinfos."' href='#' ><span class='uk-icon-times' ></span></a>";?></td></tr>
<?php
unset($colorback);
unset($colorwhite);
}
