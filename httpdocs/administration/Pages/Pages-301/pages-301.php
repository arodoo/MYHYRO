...
?>
  ...
  <script>
    $(document).ready(function() {
      ...
      $(document).on("click", "#bouton-gestion-des-pages", function() {
        $.post({
          url: '/administration/Pages/Pages-301/pages-301-action-ajouter-modifier-ajax.php',
          type: 'POST',
        ...
        listeBlocsPublicites();
      });

      //AJAX - SUPPRIMER
      $(document).on("click", ".lien-supprimer", function() {
        $.post({
          url: '/administration/Pages/Pages-301/pages-301-action-supprimer-ajax.php',
          type: 'POST',
          data: {
      ...
      function liste() {
        $.post({
          url: '/administration/Pages/Pages-301/pages-301-liste-ajax.php',
          type: 'POST',
          data: {},
          dataType: "html",
          success: function(res) {
      ...
      $(document).on('click', '#btnSupprModal', function() {
        console.log("OK");
        $.post({
          // url: '/administration/Pages/Pages-301/modal-supprimer-ajax.php',
          url: '/administration/Pages/Pages-301/modal-supprimer-ajax.php',
          type: 'POST',
          data: {
            idaction: $(this).attr("data-id")
  ...
  <ol class="breadcrumb">
    ...
    <?php if (empty($_GET['action'])) { ?> <li class="active">Gestion des redirections 301</li> <?php } else { ?> <li><a href="?page=Pages-301">Gestion des redirections 301</a></li> <?php } ?>
  ...
  echo "<div id='bloctitre' style='text-align: left;' ><h1>Gestion des redirections 301 </h1></div><br /><br />
<div style='clear: both;'></div>";
  ...
  echo "<a href='?page=Pages-404'><button type='button' class='btn btn-primary' style='margin-right: 5px;' ><span class='uk-icon-file-code-o'></span> Erreurs 404/410</button></a>";
  echo "<a href='?page=Pages-301&amp;action=Ajouter'><button type='button' class='btn btn-success' style='margin-right: 5px;' ><span class='uk-icon-plus-circle'></span> Ajouter une page</button></a>";
  if (!empty($_GET['action'])) {
    echo "<a href='?page=Pages-301'><button type='button' class='btn btn-success' style='margin-right: 5px;' ><span class='uk-icon-trash-o'></span> Liste</button></a>";
  }
  ...
  <div style='padding: 5px;' align="center">
    ...
    if ($action == "modification" || $action == "Ajouter") {
      ...
      if ($action == "modification") {
        ...
        ///////////////////////////////SELECT
        $req_select = $bdd->prepare("SELECT * FROM pages_redirections_301 WHERE id=?");
...
<form id="formulaire_modifier" method="post" action="#">';
    ?>
        ...
        <div style='text-align: left;'>
          <h2>Modification redirection 301 / page N°<?php echo "$idaction"; ?> </h2>
        </div><br />
        <div style='clear: both;'></div>
...
<form id="formulaire_ajout" method="post" action="#">';
        ...
        <div style='text-align: left;'>
          <h2>Déclarer une redirection 301</h2>
        </div><br />
        <div style='clear: both;'></div>
      ...
      <table style="text-align: left; width: 100%;" border="0" cellpadding="2" cellspacing="2" align="center">
        <tbody>
          ...
          <tr>
            <td style="text-align: left; width: 100px;">Ancienne page</td>
            <td style="text-align: left;"></td>
            <td style="text-align: left;"><input type='text' name='postancienne' class='form-control' value='<?php echo "$ancienne_pagee301"; ?>' style='width: 100%;' /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
