...
require_once('../../../../pages/paiements/Api-Paypal/paypal.php');
...
$params = array(
	...
	'CANCELURL' => "" . $http . "$nomsiteweb/Paiement-2",
...
$_SESSION['total_TTC_paypal'] = round(($_POST['prix']*0.00152449), 2);
//////////////////////////////////////////////////////PRODUITS SERVICES
...
$params["L_PAYMENTREQUEST_0_AMT$k"] = round(($_POST['prix']*0.00152449), 2);
$params["L_PAYMENTREQUEST_0_QTY$k"] = 1;

// var_dump($params, $PU_TTC_totald_panierd);

$params['PAYMENTREQUEST_0_AMT'] = round(($_POST['prix']*0.00152449), 2);
...
if (empty($erreur_paypal)) {
	$result = array("Texte_rapport"=>"","retour_validation"=>"ok","retour_lien"=>"$paypal");
