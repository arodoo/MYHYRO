    ...
    <div class="well well-sm"
                    ...
                    <div style="max-height: 15vh; overflow-y: auto; scrollbar-color: #ff9900 #dee2e6 ; padding: 1rem 2rem;">
                        ...
                        while ($ligne_boucle = $req_boucle->fetch()) {
                            ...
                            <p> - <?= $ligne_admin['prenom'] ?> a effectué une modification le
                                <?= date('d-m-Y à H:i', $ligne_boucle['date']) ?></p>
                        <?php } ?>
                    </div>
        ...
        <div style="padding: 2rem">
            ...
            <button id="annuler_commande"
                class="btn <?= $commande['statut_2'] == 3 ? "btn-danger" : "btn-primary" ?> update" data-annuler="oui"
                style="margin-right: 1rem" <?= $commande['statut_2'] == 2 || $commande['statut_2'] == 3 ? "disabled" : "" ?>>
                ...
                <div id="table-scroll">
                    <form id="form-produits" method='post' action='#' enctype='multipart/form-data'>
                        ...
                        <table id='Tableau_a2' class="display nowrap table-responsive"
                            style="text-align: center; width: 100%; margin-top: 15px; font-size: 11px" cellpadding="2"
                            cellspacing="2">
                            <thead>
                                <tr>
                                    ...
                                    <tr
                                        ...
                                        <td style="text-align: center;">
                                            <input type="text" id="<?= $ligne_boucle['id'] ?>-prix_u"
                                                class="line<?= $ligne_boucle['id'] ?> <?= $ligne_boucle['annule'] == 'oui' ? "annule" : "" ?>"
                                                name="prix_u" value="<?= round($ligne_boucle['prix'] * 0.00152449, 2); ?>"
                                        ...
                                        <td style="text-align: center;">
                                            <input type="text" id="<?= $ligne_boucle['id'] ?>-prix_u_xaf"
                                                class="line<?= $ligne_boucle['id'] ?> <?= $ligne_boucle['annule'] == 'oui' ? "annule" : "" ?>"
                                                name="prix_u_xaf"
                                                value="<?= number_format($ligne_boucle['prix'], 0, '.', ' '); ?>" disabled
                                                style="height: 2.125rem; width: 6rem;">
                                        </td>
                                        <td style="text-align: center;">
                                        ...
                                        <td style="text-align: center;">
                                            <label for="disponibilite">
                                                <select style="padding: 0.5rem; height: 2.125rem;"
                                                    ...
                                                    name="disponibilite<?= $ligne_boucle['id'] ?>" data-champ="disponibilite"
                                                    data-id="<?= $ligne_boucle['id'] ?>">
                                                    <option></option>
                                    ...
                                    <tr class="line<?= $ligne_boucle['id'] ?> <?= $even_odd_class ?> <?= $ligne_boucle['annule'] == 'oui' ? "annule" : "" ?>"
                                        ...
                                        <td style="text-align: center;">
                                            <input
                                                ...
                                                value="<?= number_format($ligne_boucle['prix_reel'], 0, '.', ' '); ?>" disabled
                                                style="width: 6rem;">
                                        </td>
                                        <td style="text-align: center;">
                                            <input
            ...
            <b>
                ...
                <?php if (!is_null($commande['frais_gestion_pf_total'])): ?>
                    <div>
                        Frais de gestion PF total : <?= number_format($commande['frais_gestion_pf_total'], 0, '.', ' '); ?> F
                        CFA
        ...
        <div style="border-top: 1px solid #dddddd; padding: 2rem">
            ...
            <div class="suivi-commande" style="display: flex;">
                <div class="commande-etape1" style=" padding-left: 1rem; padding-right: 2rem;">
                    <div style="padding-right: 2rem; border-right: 1px solid #dfdfdf;">
                        <div style="display: flex; ">
                            ...
                            <div style="margin-left: 1rem">
                                <label for="statut_expedition" style="font-weight: normal;">Etape 2 : Suivi
                                    expédition</label> <select id="statut_expedition" name="statut_expedition"
                                    class="form-control">
                                    <option value=""></option>
                                    <?php
                    ...
                    <div
                        style="margin-top: 5rem; display: flex; flex-direction: column; justify-content: flex-end; padding-right: 2rem;">
                        <div style="display: flex; align-items: center; justify-content: flex-end">
                            ...
                            <input class="form-control" type="text" name="reduction"
                                value="<?= $commande['prix_reduction'] ?>" id="reduction" style="width: 10rem;" disabled>
                        </div>
                        ...
                        <div style="display: flex; justify-content: flex-end; align-items: flex-start; margin-top: 1rem;">
                            ...
                            <input type="radio" id="oui" name="douane_a_la_livraison" value="oui" style="margin-left: 1rem"
                                <?php echo $commande['douane_a_la_liv'] == 'oui' ? 'checked' : ''; ?> disabled>
                            <label for="oui" style="margin-left:0.5rem; font-weight: normal;">Oui</label>
                            <input type="radio" id="non" name="douane_a_la_livraison" value="non" style="margin-left: 1rem"
                                <?php echo $commande['douane_a_la_liv'] != 'oui' ? 'checked' : ''; ?> disabled>
                            <label for="non" style="margin-left:0.5rem; font-weight: normal;">Non</label><br>
                        </div>

                        <div style="display: flex; justify-content: flex-end; margin-top: 1rem;">
                            <label for="prix_expedition" style="margin-right: 1rem; font-weight: normal;">Montant de la
                                douane et transport</label>
                        ...
                        <div style="display: flex; align-items: center; justify-content: flex-end; margin-top: 5rem;">
                            ...
                            <input class="form-control" type="text" name="montant_a_payer" id="montant_a_payer"
                                style="width: 10rem;" value="<?= number_format($prix_total, 0, '.', ' ') ?>" disabled>
                        </div>
                    </div>
                ...
                <div class="commentaire-livraison" style=" padding-left: 5rem; padding-right: 2rem;">
                    <div>
                        ...
                        <br>
                        <textarea class="form-control" style="width: 100%; height: 15rem; resize: none"
                    ...
                    <div style="margin-top: 5rem;">
                        ...
                        <div style="display: flex; align-items: center">
                            <label for="code_de_reduction" style="margin-right: 1rem; font-weight: normal;">Code de
                                réduction</label>
                            <input class="form-control" type="text" value="<?= $commande['code_promo'] ?>"
                                name="code_de_reduction" id="code_de_reduction" style="width: 10rem;" disabled>
                        </div>

                        <div class="suivi-kg"
                            style="display: flex;flex-wrap: wrap; margin-top: 11rem; align-content: center; ">
                            ...
                            <div class="margin-kg" style="margin-right: 5rem">
                                ...
                                <input class="form-control" type="text" value="<?= round($prix_kilo_colis / 0.00152449) ?>"
                                    name="prix_du_kg" id="prix_du_kg" style="width: 10rem;" disabled>
                            </div>
                            <div class="margin-kg" style="margin-right: 1rem">
                                <label for="douane_et_transport_reel" style="font-weight: normal;">Douane et transport
                                    réel</label>
                                <input class="form-control" type="text" name="douane_et_transport_reel" value=""
                                    id="douane_et_transport_reel" style="width: 10rem;" disabled>
                            </div>
                            <div>
                                <label for="ecart" style="font-weight: normal;">Ecart</label>
                                <input class="form-control" type="text" name="ecart" id="ecart" value=""
                    ...
                    <div class="dates input-expedition" style="align-content: center; justify-content: space-around;">
                        <div style="margin-right: 1rem">
                            ...
                            <input class="form-control" type="text" value="<?= $commande['lot_expedition'] ?>"
                                name="lot_expedition" id="lot_expedition" style="width: 10rem;">
                        </div>
                        <div>
                            <?php
                            ...
                            <input class="form-control" type="date" value="<?= $date_envoi ?>" name="date_envoi"
                                id="date_envoi" style="width: 14rem;">
                        </div>
        ...
        <div style="border-top: 1px solid #dddddd; padding: 2rem;">
            ...
            <div class="paiement">
                <div class="paiement-element"
                    style="border-right: 1px solid #dfdfdf; padding-left: 1rem; padding-right: 2rem;">
                ...
                <div class="paiement-element2"
                    style="padding-left: 2rem; padding-right: 2rem; border-right: 1px solid #dfdfdf;">
                ...
                <div style="padding-left: 2rem; padding-right: 1rem;">
                    <div class="adresse">
                        <div style='text-align: left;'>
                            ...
                            <div id="text-fac"
                                style="border: #80808070 1px solid;  padding: 1rem; width: 25rem; min-height: 120px; max-height: 150px;">
                                <?= nl2br($commande['adresse_fac']) ?>

                            </div>
                            <textarea
                                style="display: none; border: #80808070 1px solid;  padding: 1rem; width: 25rem; min-height: 120px; max-height: 150px;"
                                name=""
                                id="adresse_fac"><?= str_replace("<br>", "\n", $commande['adresse_fac']) ?></textarea>
            ...
            <div class="remboursement">
                ...
                <div class="encaissement">
                    ...
                    <div class="remboursement">
                        ...
                        <div>
                            <div
                                style="display: flex; align-items: center; justify-content: flex-end; margin-bottom: 1rem;">
                                <label for="montant_a_payer" style="margin-right: 1rem; font-weight: normal;">Montant à
                                    payer</label>
                                <input class="form-control" type="text" name="montant_a_payer" id="montant_a_payer"
                            ...
                            <div style="display: flex; align-items: center; justify-content: flex-end;">
                                <label for="montant_paye_client" style="margin-right: 1rem; font-weight: normal;">Montant
                                    payé par le client :</label>
                    ...
                    <div class="remboursement" style=" margin-top: 3rem;">
                        <div>
                            <div style='display: flex; align-items: center; justify-content: flex-end; margin-top: 1rem;'>
                                <label for="montant_recu" style="font-weight: normal; margin-right: 1rem;">Montant
                                    reçu</label>
                        ...
                        <div style="margin-left: 5rem">
                            ...
                            <div style="display: flex; align-items: center; justify-content: flex-end; margin-top: 1rem;">
                                <label for="statut_paiement" style="font-weight: normal; margin-right: 1rem;">Statut de
                                    paiement : </label>
                    ...
                    <div style="margin-top: 3rem;max-height: 15vh; overflow-y: auto;">
                        ...
                        while ($ligne_boucle = $req_boucle->fetch()) {
                            ...
                            <p>- Paiement <?= $ligne_boucle['moyen'] ?>         <?= $ligne_boucle['mode_encaissement'] ?>
                                <?= $ligne_boucle['telephone_airtel'] ?> de <?= $ligne_boucle['montant'] ?> f cfa réalisé le
                                <?= $ligne_boucle['date'] ?>
                ...
                <div
                    ...
                    <?php if ($alert == "oui") { ?>
                        <div class="alert alert-danger"><i class="uk-icon-warning"></i> Attention! des articles ont été annulés,
                            veuillez procéder au remboursement si besoin</div>
                    <?php } ?>
                    <div>
                        ...
                        <div style="display: flex; align-items: center; justify-content: flex-end; margin-bottom: 1rem;">
                            ...
                            <input class="form-control" type="text" name="total_rembourse" id="total_rembourse"
                                value="<?= number_format($commande['total_rembourse'], 0, '.', ' ') ?>"
                    ...
                    <div style="margin-top: 3rem">
                        ...
                        <div style='display: flex; align-items: center; justify-content: flex-end; margin-top: 5rem;'>
                            <label for="motif_remboursement" style="font-weight: normal; margin-right: 1rem;">Motif :
                            </label>
