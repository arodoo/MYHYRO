...
if (
  ...
  <ol class="breadcrumb">
    ...
    <?php if (empty($_GET['action'])) { ?>
      <li class="active">Gestion des abonnés</li> <?php } else { ?>
      <li><a href="?page=Abonnes">Gestion des abonnés</a></li> <?php } ?>
    <?php if ($_GET['action'] == "modifier") { ?>
      <li class="active">Modifications</li> <?php } ?>
    <?php if ($_GET['action'] == "addm") { ?>
      <li class="active">Ajouter</li> <?php } ?>
    <?php if ($_GET['action'] == "Graphique") { ?>
      <li class="active">Graphique</li> <?php } ?>
  </ol>
    ...
    if ($action == "Ajouter" || $action == "Modifier") {
      ...
      if ($action == "Modifier") {
        ...
        <form id='formulaire-modifier' method='post' action='#'>
          ...
          <input name="action" class="form-control" type="hidden" value="<?php echo "Modifier-action"; ?>"
            style='width: 100%;' />
          ...
          <div style='text-align: center; margin-right: auto; margin-left: auto;'>
            ...
            <form id='formulaire-ajouter' method='post' action='#'>
              <input name="idaction" class="form-control" type="hidden" value="<?php echo "$idaction"; ?>"
                style='width: 100%;' />
              ...
              <div class="well well-sm" style="width: 100%; text-align: left;">
                ...
                <table style='text-align: center; width: 100%;' cellpadding='2' cellspacing='2'>
                      ...
                      <select name="Abonnement_id" id="Abonnement_id" class="form-control" style='width: 100%;' required>
                        ...
                        while ($ligne_boucle = $req_boucle->fetch()) {
                          ...
                          <option <?php if ($ligne_boucle['id'] == $ligne_select['Abonnement_id']) {
                            ...
                            value="<?php echo $ligne_boucle['id']; ?>"> <?php echo $ligne_boucle['nom_abonnement']; ?>
                          </option>
                        <?php
                        }
                  ...
                  <tr>
                    <td style='text-align: left; min-width: 120px;'>Abonnement demandé</td>
                    <td style='text-align: left;'>
                      <?php
                  ...
                  <tr>
                    <td style='text-align: left; min-width: 120px;'>Date demande</td>
                    <td style='text-align: left;'>
                      <?php
                  ...
                  <tr>
                    <td style='text-align: left; min-width: 120px;'>Fiche</td>
                    <td style='text-align: left;'>
                      <a href="?page=Membres&amp;action=Modifier&amp;idaction=<?php echo $ligne_select['id']; ?>"
                  ...
                  <tr>
                    <td style='text-align: left; min-width: 120px;'>N°Client</td>
                    <td style='text-align: left;'>
                  ...
                  <tr>
                    <td style='text-align: left; min-width: 120px;'>Prénom</td>
                    <td style='text-align: left;'>
                  ...
                  <tr>
                    <td style="font-weight: bold; text-align: left;">Dates</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  </tr>
                  ...
                  <tr>
                    <td style='text-align: left; min-width: 120px;'>Date commande</td>
                    <td style='text-align: left;'>
                  ...
                  <tr>
                    <td style='text-align: left; min-width: 120px;'>Expire le, </td>
                    <td style='text-align: left;'>
                      <?php if (!empty($ligne_select['Abonnement_date_expiration'])) {
                        echo date('m-d-Y', $ligne_select['Abonnement_date_expiration']);
                      } else {
                        echo "-";
                      } ?>
                    </td>
                  ...
                  <tr>
                    <td style='text-align: left; min-width: 120px;'>Date paiement</td>
                    <td style='text-align: left;'>
                  ...
                  <tr>
                    <td style='text-align: left; min-width: 120px;'>Jours restant</td>
                    <td style='text-align: left;'>
                  ...
                  <tr>
                    <td style="font-weight: bold; text-align: left;">Expiration</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  </tr>
                  ...
                  <tr>
                    <td style='text-align: left; min-width: 120px;'>Modifier l'expiration</td>
                    <td style='text-align: left;'>
                      <input name="date_new_expiration" class="form-control" type="date" id="date_new_expiration" value=""
                  ...
                  <tr>
                    <td style="font-weight: bold; text-align: left;">Paiement</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  </tr>
                  ...
                  if (!empty($ligne_select['Abonnement_last_facture_numero'])) {
                    ...
                    <tr>
                      ...
                      <td style='text-align: left;'>
                        <a href="/facture/<?php echo $ligne_select['Abonnement_last_facture_numero']; ?>/<?php echo $nomsiteweb; ?>"
                  ...
                  <tr>
                    ...
                    <td style='text-align: left;'>
                      <select name="Abonnement_paye" id="Abonnement_paye" class="form-control" style='width: 100%;'
                        required>
                  ...
                  <tr>
                    ...
                    <td style='text-align: left;'>
                      <select name="Abonnement_mode_paye" id="Abonnement_mode_paye" class="form-control"
                        ...
                        while ($ligne_boucle = $req_boucle->fetch()) {
                          ...
                          <option <?php if ($ligne_select['Abonnement_paye_demande'] == $ligne_boucle['nom_mode']) {
                            echo "selected";
                          } ?> value="<?php echo $ligne_boucle['nom_mode']; ?>">
                            <?php echo $ligne_boucle['nom_mode']; ?></option>
                        <?php
                        }
                        $req_boucle->closeCursor();
                        ?>
                  ...
                  <tr>
                    <td tyle='text-align: left; min-width: 120px; font-weight: bold;'>Modifier date paiement</td>
                    <td style='text-align: left;'>
                      <input name="Abonnement_date_paye" class="form-control" type="date" id=" Abonnement_date_paye"
                        value="" style='width: 100%; min-width: 200px;' required />
                    </td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    <td colspan="2" style='text-align: left; min-width: 120px;'><input name="generer_facture"
                        class="form-control" type="checkbox" id="generer_facture"
                        value="oui"' required style="height: 15px; width: 15px; display: inline-block;"  /> Générer une facture pour l'
                        abonnement (La facture aura la date du jour) </td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  </tr>
                  ...
                  <tr>
                    <td colspan="2" style='text-align: left; min-width: 120px;'>Activer l'abonnement demandé <br><br>
                ...
                <div style="border-top: 1px solid #dddddd; padding: 2rem;">
                  ...
                  <table style='text-align: center; width: 100%;' cellpadding="2" cellspacing="2">
                    ...
                    <tr>
                      ...
                      <td style='text-align: left;'><label for="statut_2">Suivi achat</label> <select id="statut_2"
                          name="statut_2" class="form-control" style="width:50%">
                          <option value=""></option>
                          <?php
                  ...
                  <div>
                    <label for="message">Messages prédéfinis</label> <select id="message" name="message"
                ...
                <div style="border-top: 1px solid #dddddd; padding: 2rem;">
                  ...
                  <div style="display: flex;">
                    ...
                    <div style="width: 70%">
                      ...
                      <div style="display: flex;">
                        ...
                        <div>
                          <div style="display: flex; align-items: center; justify-content: flex-end; margin-bottom: 1rem;">
                            <label for="montant_a_payer" style="margin-right: 1rem; font-weight: normal;">Montant à
                              payer</label>
                          ...
                          <div style="display: flex; align-items: center; justify-content: flex-end;">
                            <label for="montant_paye_client" style="margin-right: 1rem; font-weight: normal;">Montant payé
                              par le client :</label>
                            <input class="form-control" type="text" name="montant_paye_client" id="montant_paye_client"
                              value="<?= $commande['montant_paye_client'] ? $commande['montant_paye_client'] : 0 ?>"
                        ...
                        <div style="margin-left: 10rem">
                          <div style='display: flex; align-items: center; justify-content: flex-end; margin-bottom: 1rem;'>
                            <label for="total_a_regulariser" style="margin-right: 1rem; font-weight: normal;">Total à
                              régulariser</label>
                            <input class="form-control" disabled type="text" name="total_a_regulariser"
                              value="<?= !empty($commande['prix_total_reel']) ? $commande['prix_total_reel'] - $commande['montant_paye_client'] : $commande['prix_total'] - $commande['montant_paye_client'] ?>"
                              id="total_a_regulariser" style="width: 10rem; margin-right: 1rem;">
                          </div>

                          <div style='display: flex; align-items: center; justify-content: flex-end;'>
                            <label for="restant_payer" style="margin-right: 1rem; font-weight: normal;">Restant à
                              payer</label>
                            <input class="form-control" type="text" name="restant_payer" id="restant_payer"
                              value="<?= $commande['restant_payer'] ?>" style="width: 10rem; margin-right: 1rem;">
                          </div>
                        </div>
                      </div>
                      <div style="display: flex; margin-top: 3rem;">
                        <div>
                          ...
                          <div style="display: flex; align-items: center; justify-content: flex-end; margin-top: 1rem;">
                            <label for="moyen_d_encaissement" style="font-weight: normal; margin-right: 1rem;">Moyen
                              d'encaissement : </label>
                            <select name="moyen_d_encaissement" id="moyen_d_encaissement"
                              style="width: 10rem; margin-right: 1rem;" class="form-control">
                          ...
                          <div style="display: flex; align-items: center; justify-content: flex-end; margin-top: 1rem;">
                            <label for="type_d_encaissement" style="font-weight: normal; margin-right: 1rem;">Type
                              d'encaissement : </label>
                            <select name="type_d_encaissement" id="type_d_encaissement"
                              style="width: 10rem; margin-right: 1rem;" class="form-control">
                        ...
                        <div style="margin-left: 5rem">
                          <div style='display: flex; align-items: center; justify-content: flex-end; margin-top: 1rem;'>
                            <label for="date_de_reception" style="font-weight: normal; margin-right: 1rem;">Date de
                              réception</label>
                          ...
                          <div style="display: flex; align-items: center; justify-content: flex-end; margin-top: 1rem;">
                            <label for="statut_paiement" style="font-weight: normal; margin-right: 1rem;">Statut de paiement
                              : </label>
                            <select name="statut_paiement" id="statut_paiement" style="width: 14rem; margin-right: 1rem;"
                              class="form-control">
                          ...
                          <div style='display: flex; align-items: center; justify-content: flex-end; margin-top: 1rem;'>
                            <label for="echeance_du" style="font-weight: normal; margin-right: 1rem;">A échéance du :
                            </label>
                        ...
                        <div style="margin-left: 5rem">
                          <?php if (!empty($commande['id_paiement_pf'])) {
                            ...
                            <div style='display: flex; align-items: center; justify-content: flex-end; margin-top: 1rem;'>
                              <label for="echeancier1" style="font-weight: normal; margin-right: 1rem;">1er
                            ...
                            <div style='display: flex; align-items: center; justify-content: flex-end; margin-top: 1rem;'>
                              <label for="echeancier2" style="font-weight: normal; margin-right: 1rem;">2e
                            ...
                            <?php if (!empty($commande['dette_montant_pf3'])) { ?>
                              <div style='display: flex; align-items: center; justify-content: flex-end; margin-top: 1rem;'>
                                <label for="echeancier3" style="font-weight: normal; margin-right: 1rem;">3e
                      ...
                      <div style='display: flex; align-items: center; margin-top: 5rem;'>
                        ...
                        <input class="form-control" type="text" name="motif_encaissement" id="motif_encaissement"
                          value="<?= $commande['motif_encaissement'] ?>" style="width: 20rem; margin-right: 1rem;">
                      </div>
                      ...
                      <div style="margin-top: 3rem">
                        ...
                        while ($ligne_boucle = $req_boucle->fetch()) {
                          ?>
                          <p>- Paiement <?= $ligne_boucle['moyen'] ?>       <?= $ligne_boucle['mode_encaissement'] ?> de
                            <?= $ligne_boucle['montant'] ?> f cfa réalisé le <?= $ligne_boucle['date'] ?>
                    ...
                    <div
                      style="border-left: 1px solid #dfdfdf; padding-left: 2rem; padding-right: 1rem; display: flex; flex-direction: column; align-items: center;">

                      <h5 style="font-weight: bold">Remboursement</h5>
                      <?php if ($alert == "oui") { ?>
                        <div class="alert alert-danger"><i class="uk-icon-warning"></i> Attention! des articles ont été
                          annulés, veuillez procéder au remboursement si besoin</div>
                      <?php } ?>
                      <div>
                        <div style="display: flex; align-items: center; justify-content: flex-end; margin-bottom: 1rem;">
                          <label for="montant_rembourser" style="margin-right: 1rem; font-weight: normal; ">Montant à
                            rembourser</label>
                          <input class="form-control" type="text" name="montant_rembourser" id="montant_rembourser"
                            value="<?= $commande['montant_rembourser'] ?>" style="width: 14rem; margin-right: 1rem;">
                        </div>

                        <div style="display: flex; align-items: center; justify-content: flex-end; margin-bottom: 1rem;">
                          <label for="restant_rembourser" style="margin-right: 1rem; font-weight: normal;">Restant à
                            rembourser</label>
                          <input class="form-control" type="text" name="restant_rembourser" id="restant_rembourser"
                            value="<?= $commande['restant_rembourser'] ?>" style="width: 14rem; margin-right: 1rem;">
                        </div>

                        <div style="display: flex; align-items: center; justify-content: flex-end; margin-bottom: 1rem;">
                          <label for="total_rembourse" style="margin-right: 1rem; font-weight: normal;">Total
                            remboursé</label>
                          <input class="form-control" type="text" name="total_rembourse" id="total_rembourse"
                            value="<?= $commande['total_rembourse'] ?>" style="width: 14rem; margin-right: 1rem;" disabled>
                        </div>
                      </div>

                      <div style="margin-top: 3rem">
                        <div style="display: flex; align-items: center; justify-content: flex-end; margin-bottom: 1rem;">
                          <label for="regulariser" style="margin-right: 1rem; font-weight: normal;">Montant
                            remboursé</label>
                          <input class="form-control" type="text" name="regulariser" id="regulariser"
                            style="width: 14rem; margin-right: 1rem;">
                        </div>
                        <div style="display: flex; align-items: center; justify-content: flex-end; margin-bottom: 1rem;">
                          <label for="date_rem" style="margin-right: 1rem; font-weight: normal;">Date de
                            remboursement</label>
                          <input class="form-control" type="date" name="date_rem" id="date_rem"
                            style="width: 14rem; margin-right: 1rem;">
                        </div>
                        <div style="display: flex; align-items: center; justify-content: flex-end; margin-bottom: 1rem;">
                          <label for="moyen_de_remboursement" style="font-weight: normal; margin-right: 1rem;">Moyen de
                            remboursement </label>
                          <select name="moyen_de_remboursement" id="moyen_de_remboursement"
                            style="width: 14rem; margin-right: 1rem;" class="form-control">
                            <option value="Espèces">Espèces</option>
                            <option value="Chèque">Chèque</option>
                            <option value="Airtel money">Airtel money</option>
                            <option value="Flooz">Flooz</option>
                        ...
                        <div style='display: flex; align-items: center; justify-content: flex-end; margin-top: 5rem;'>
                          ...
                          <input class="form-control" type="text" name="motif_remboursement" id="motif_remboursement"
                            value="<?= $commande['motif_remboursement'] ?>" style="width: 20rem; margin-right: 1rem;">
                        </div>
                      ...
                      <div style="margin-top: 3rem">
                        ...
                        while ($ligne_boucle = $req_boucle->fetch()) {
                          ?>
                          <p>- Remboursement <?= $ligne_boucle['moyen'] ?> de <?= $ligne_boucle['montant'] ?> f cfa réalisé le
                            <?= $ligne_boucle['date'] ?>
              ...
              <br />
              <button id='modifier' type='button' class='btn btn-success' onclick="return false;"
