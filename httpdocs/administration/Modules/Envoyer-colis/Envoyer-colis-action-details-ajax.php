    ...
    <script>
        $(document).ready(function() {
            ...
            /*$(document).on("change", ".modif_produit", function () {
                ...
                $.post({
                    url: '/administration/Modules/colis/colis-action-produits-ajax.php',
                    type: 'POST',
                    data: datas,
                    success: function (res) {
                        res = JSON.parse(res);
    ...
    <div class="well well-sm" style="margin-top: 2rem; text-align: left; width: 96vw; position: absolute; top: 40vh; left: 2vw; right: 2vw; ">
        ...
        <div style="border-top: 1px solid #dddddd; padding: 2rem;">
            ...
            <!--table style='text-align: center; width: 100%;' cellpadding='2' cellspacing='2'>
                ...
                <input id="idWish" style="display:none" disabled value="<?= $colis['id']; ?>"/>
                <input id="idMembre" style="display:none" disabled value="<?= $colis['user_id']; ?>"/>

                <tr>

                    <td style='text-align: left; font-weight:bold'>
                        <?php
                        if (!empty($colis['id_paiement_pf'])) {
                            if ($colis['id_paiement_pf'] == '2' || $colis['id_paiement_pf'] == '1' || $colis['id_paiement_pf'] == '4' || $colis['id_paiement_pf'] == '3') {

                                echo $colis['dette_montant_pf'] ?> <select id='dette_payee_pf' name='dette_payee_pf'
                                ...
                                <br>
                                <?php echo $colis['dette_montant_pf2'] ?>
                                <select id='dette_payee_pf2' name='dette_payee_pf2' class='form-control' style='width:50%'>
                                    <option value='Payé' <?php if ($colis['dette_payee_pf2'] == 'Payé') {
                                                                echo 'selected';
                                                            } ?>>Payé</option>
                            ...
                            } elseif ($colis['id_paiement_pf'] == '6' || $colis['id_paiement_pf'] == '5') {

                                echo $colis['dette_montant_pf'] ?>
                                ...
                                <br>
                                <?php echo $colis['dette_montant_pf3'] ?>
                                <select id='dette_payee_pf3' name='dette_payee_pf3' class='form-control' style='width:50%'>
                                    <option value='Payé' <?php if ($colis['dette_payee_pf3'] == 'Payé') {
                                                                echo 'selected';
                                                            } ?>>Payé</option>
        ...
        <!--<div style="border-top: 1px solid #dddddd; padding: 2rem;">
            ...
            <table style='text-align: center; width: 100%;' cellpadding='2' cellspacing='2'>
                ...
                <tr>
                    ...
                    <td style='text-align: left;'>
                        <select id="statut" class="form-control" style="width:200px">
                            <option value="4" <?php /*if ($colis['statut'] == "4") { */ ?> selected <?php /*} */ ?>>Payé</option>
                            <option value="5" <?php /*if ($colis['statut'] == "5") { */ ?> selected <?php /*} */ ?>>En attente de paiement</option>
                            <option value="6" <?php /*if ($colis['statut'] == "6") { */ ?> selected <?php /*} */ ?>>Terminé</option>
                        </select>
                    </td>
                </tr>
                <tr>
                ...
                <?php /*if (!empty($colis['dette_montant'])) { */ ?>
                    <tr>
                        <td style='text-align: left; font-weight:bold'>Dette Frais douane et expédition colis :</td>
                        <td style='text-align: left;'>
                            <?php /*= $colis['dette_montant'] */ ?> CFA
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td style='text-align: left;'>
                            <select id="dette_payee" class="form-control" style="width:200px">
                                <option value="oui" <?php /*if ($colis['dette_payee'] == "oui") { */ ?> selected <?php /*} */ ?>>
                                    Oui
                                </option>
                                <option value="non" <?php /*if ($colis['dette_payee'] == "non") { */ ?> selected <?php /*} */ ?>>
                                    Non
                                </option>
                            </select>
                        </td>
                ...
                <?php /*} else if ($colis['statut'] == 5) {
                    $sql_select = $bdd->prepare("SELECT * FROM membres_regulation WHERE id_membre=? AND id_colis=?");
                    $sql_select->execute(array(htmlspecialchars($colis['user_id']), htmlspecialchars($colis['id'])));
                    $regulation = $sql_select->fetch();
                    $sql_select->closeCursor();
                    */ ?>
                    <input id="idRegul" style="display:none" disabled value="<?php /*= $colis['id_regulation']; */ ?>"/>
