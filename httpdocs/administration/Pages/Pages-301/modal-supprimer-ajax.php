...
$req_select = $bdd->prepare("SELECT ancienne_page FROM pages_redirections_301 WHERE id = ?");
$req_select->execute(array($idaction));
$anciennePage = $req_select->fetch();
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>Êtes-vous sûr(e) de vouloir supprimer <?php echo $anciennePage['ancienne_page']; ?> ?</p>
      </div>
